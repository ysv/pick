(function() {
    ...
    function trackPageview(vars) {
        ...
        img.addEventListener('load', function() {
            ...
            setCookie('_pick', JSON.stringify(data), { expires: midnight, path: '/' });
    ...
    queue.forEach((i) => pick.apply(this, i));
})()
